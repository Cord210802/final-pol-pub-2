...
\vspace*{8pt}
\centering
{\small Prevalencia de agresión adulta según conductas de riesgo adolescentes}\\[4pt]
\includegraphics[width=0.95\linewidth]{figuras/04_prevalence_risk_behaviors_notitle.png}
...
\vspace*{8pt}
\centering
{\small Diagnóstico del modelo lineal final ($M_5$)}\\[4pt]
\includegraphics[width=0.90\linewidth]{figuras/06_diagnostics_m5_notitle.png}
